...
public class MergeDescendantWithAncestorScenario implements JsTestScenario {
    /*
    center{
        -ra1->a1{
            -ra2->a2{
    ...
    public JSONObject build() {
        ...
        a21.mergeTo(a1);
        SubGraphPojo a1AfterSubGraphMerge = userGraph.aroundForkUriInShareLevels(
                a1.uri(),
                ShareLevel.allShareLevelsInt
        );
        try {
            return new JSONObject().put(
                    ...
                    "a1SubGraphAfterMerge",
                    SubGraphJson.toJson(
                            a1AfterSubGraphMerge
                    )
            );
